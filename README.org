...
* Configuration
The 'make tangle' command yields all dotfiles into '~/dotfiles' which suits my needs. Feel free to change the 'tangle-root' property in [[file:dotfiles.org][dotfiles.org]] as your liking.
