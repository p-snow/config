...
- extraction destination
  ...
  With the command above, all dotfiles will be located under the path below, which is my preference but can be customized by modifying the following line in [[id:e69ebc68-c604-4f37-b61b-59f4fb5440b0][this node]].
