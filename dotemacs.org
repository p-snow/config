...
#+begin_src emacs-lisp
  ...
  (use-package face
    ...
    ((org-mode text-mode mu4e-headers-mode mu4e-compose-mode) . (lambda () (buffer-face-set 'my/medium-gothic-face)))
    (prog-mode . (lambda () (buffer-face-set 'my/small-gothic-face)))
...
#+begin_src emacs-lisp
  (use-package adaptive-wrap
    :straight t
    :hook
    (((elfeed-show-mode eww-after-render help-mode helpful-mode Info-mode woman-mode mu4e-view-mode nov-mode twittering-mode text-mode) .
      visual-line-mode)
     ((elfeed-show-mode eww-after-render help-mode helpful-mode Info-mode woman-mode mu4e-view-mode nov-mode twittering-mode) .
...
#+begin_src emacs-lisp
  (use-package whitespace
    :diminish ((global-whitespace-mode . "Ws")
               (whitespace-mode . "ws"))
    :hook
    ((org-mode prog-mode) . whitespace-mode)
