...
* configuration                :elfeed:soft_update:prime:
...
#+begin_src emacs-lisp
  ...
  (use-package face
    ...
    ((org-mode mu4e-headers-mode mu4e-compose-mode) . (lambda () (buffer-face-set 'my/medium-gothic-face)))
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'hydra
    (defhydra hydra-org (global-map "C-o"
      ...
      ("C-g" nil "quit")))
#+end_src
** main modes for programming/editing       :programs:
:PROPERTIES:
