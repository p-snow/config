...
#+PROPERTY: tangle-target-dir ~/ghq/github.com/p-snow/.files
...
#+begin_src emacs-lisp
  (use-package calendar
    ...
    (setf calendar-holidays
          (append japanese-holidays holiday-general-holidays holiday-local-holidays holiday-other-holidays))
...
#+begin_src emacs-lisp
  (use-package elfeed-org
    ...
    :after (elfeed org)
    :custom
    (rmh-elfeed-org-files '("~/org/index/feed.org" "~/ghq/github.com/p-snow/dotfiles/dotemacs.org"))
...
#+begin_src emacs-lisp :tangle (expand-tangle-target ".emacs.d/site-lisp/view-file.el")
  (defcustom my/view-file--temp-dir "~/tmp"
...
Wrapper script for [[file:dotbins.org::* filetype][filetype.rb]].
