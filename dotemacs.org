...
** basic config
:PROPERTIES:
:header-args+: :tangle (expand-tangle-target ".config/emacs/01-basic.el")
:END:
...
** built-in features
:PROPERTIES:
:header-args+: :tangle (expand-tangle-target ".config/emacs/02-built-ins.el")
:END:
*** Auto Revert
...
#+begin_src emacs-lisp :tangle (expand-tangle-target ".config/emacs/site-lisp/org-archive.el")
  (require 'org)
  (require 'org-agenda)
...
#+begin_src emacs-lisp :tangle (expand-tangle-target ".config/emacs/site-lisp/org-capture-derived.el")
  (require 'thingatpt)
  (require 'whitespace)
...
#+begin_src emacs-lisp :tangle (expand-tangle-target ".config/emacs/site-lisp/org-relate.el")
  (require 'thingatpt)
  (require 'org-ql-search)
