...
- config file
 #+begin_src yaml-ts :tangle (expand-file-name ".config/xremap/config.yml")
   modmap:
     - name: CapsCtrlSwap
       remap:
         CapsLock: Ctrl_L
...
#+begin_src yaml-ts :noweb tangle :tangle (expand-file-name ".config/interception/udevmon.yaml")
...
#+begin_src yaml-ts :tangle (expand-file-name ".config/interception/dual-function-keys.yaml")
  TIMING:
    TAP_MILLISEC: 400
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-S-y") #'duplicate-dwim)
  ...
  (use-package dired
    ...
    (with-eval-after-load 'open-file
      (setq dired-guess-shell-alist-user
            (list `(,(regexp-opt (append my/open-file-media-extensions
...
#+begin_src emacs-lisp
  (use-package org-web-track
    ...
    :config
    (bind-keys ("C-o T q" . my/org-web-track-ql-view)
               ("C-o T a" . org-web-track-agenda-view)
               ("C-o T n" . org-web-track-setup)
               ("C-o T u" . org-web-track-update)
               ("C-o T U" . org-web-track-update-all)
...
#+begin_src emacs-lisp
  (use-package guix
    :config
    (with-eval-after-load 'my-invoke-command
      (bind-keys :map my/invoke-command-map
                 ("x" . guix))))
#+end_src
...
#+begin_src emacs-lisp
  (use-package emacs
    :bind (:prefix "C-x C-y"
                   :prefix-map my/cycle-visual-repeat-map
                   :prefix-docstring "Keymap to repeat toggle/cycling appearance.  Used in `repeat-mode'."
