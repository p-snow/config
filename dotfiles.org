...
#+begin_src emacs-lisp
  (use-package elfeed-org
    ...
    :after (elfeed org)
    :custom
    (rmh-elfeed-org-files '("~/org/index/feed.org" "~/org/config/dotfiles.org"))
...
***** [[https://github.com/company-mode/company-mode/releases.atom][company-mode]]
...
*** package management
:PROPERTIES:
:header-args+: :tangle (expand-tangle-target "~/share/emacs/straight/versions/default.el")
:END:

#+begin_src emacs-lisp :comments noweb :tangle-mode (identity #o644)
  (("Emacs-wgrep" . "f9687c28bbc2e84f87a479b6ce04407bb97cfb23")
   ...
   ("app-launcher" . "80a9ed37892ee6e21fe44487ed11f66a15e3f440")
   ...
   ("emacs-request" . "99ae82f1f578787bc19100970ce108dbd247fa27")
...
- crontab job definitions for my private PC
  #+begin_src conf :noweb tangle :tangle (expand-tangle-target ".config/crontab/desktop")
    MAILTO="<<email()>>"
...
- how to activate cron jobs
  1. load cron job definition file
     : $ crontab ~/.config/crontab/desktop
** Aspell
...
- gpg-agent config
  #+begin_src conf :noweb tangle :tangle (expand-tangle-target ".gnupg/gpg-agent.conf")
    ...
    enable-ssh-support
    default-cache-ttl <<hours-in-sec(h=72)>>
    maximum-cache-ttl <<hours-in-sec(h=72)>>
...
- back_btrfs.sh
  #+begin_src shell :tangle (expand-tangle-target ".local/bin/back_btrfs.sh")
    ...
    backup_subvol "${MNT_NVME}"/snapshots/data "${MNT_NVME}"/backups/data "${MNT_HDD}"/backups/data
  #+end_src
- back_rsync.sh
