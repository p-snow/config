...
- a script encoding DVD data to H.265 video
  ...
  #+end_src
- a script encoding to VP9 video
  ...
  #+begin_src shell :tangle (expand-tangle-target ".local/bin/vp9encode") :tangle-mode (identity #o555)
    ...
    vp9_opts_pass2='-c:v libvpx-vp9 -cpu-used 4 -threads 3 -row-mt 1 -speed 1 -b:v 0 -crf 23 -pass 2'
