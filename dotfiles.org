...
#+begin_src emacs-lisp :tangle (expand-file-name "my-org-flush-blobs.el" tangle/emacs-config-dir)
...
#+begin_src emacs-lisp :noweb tangle :tangle (expand-file-name "batch/org-flush-blobs.el" tangle/emacs-config-dir)
  (require 'org-habit)
  (require 'org-clock)
