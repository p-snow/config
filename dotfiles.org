...
#+name: user-bin-dir
#+begin_src emacs-lisp :noweb yes :var dot-home=(org-entry-get nil "tangle-root" t)
...
#+begin_src emacs-lisp :tangle (expand-file-name "my-org-flush-blobs.el" my/user-config-dir)
  (defvar my/org-flush-blobs-old-timestamp-in-day 60
...
#+begin_src emacs-lisp :noweb tangle :tangle (expand-file-name "batch/org-flush-blobs.el" my/user-config-dir)
  (require 'org-habit)
  (require 'org-clock)
...
#+begin_src emacs-lisp :noweb yes :tangle (file-name-concat user-emacs-directory-default "templates/minibuffer.eld")
  (guix-search "guix search " (p "regexp"))
...
#+begin_src emacs-lisp
  ...
  (rx-define parened (paren-open-char element)
    (eval (with-syntax-table (if (derived-mode-p 'reb-lisp-mode)
...
#+begin_src conf :noweb yes :noweb-ref cronjob-user
  <<random(max=59)>> * * * * <<which(filename="sync-annex-doc")>>
#+end_src

#+begin_src shell :noweb tangle :tangle (expand-file-name ".local/bin/sync-annex-doc")
