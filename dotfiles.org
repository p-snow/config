...
- /etc/fstab file for my personal machine
  #+begin_src conf :noweb tangle :tangle ~/tmp/pc01.fstab
    PARTUUID=2b97745f-01 /mnt/ssd01/ btrfs noauto,x-systemd.automount,x-systemd.device-timeout=5,nofail 0 2
    ...
    PARTUUID=2b97745f-01 <<home-dir()>>/work btrfs noauto,x-systemd.automount,x-systemd.device-timeout=5,nofail,relatime,space_cache,compress=zstd,subvolid=717 0 0

    PARTUUID=4a49c08b-01 /mnt/hdd01 btrfs noauto,x-systemd.automount,x-systemd.device-timeout=5,nofail,relatime,space_cache,subvolid=5,subvol=/ 0 2
...
#+begin_src bash :tangle (expand-tangle-target ".bash_profile")
  ...
  ACTIVE_PROFILES=(desktop emacs)

  for profile in ${ACTIVE_PROFILES[@]}; do
    profile_path=${GUIX_EXTRA_PROFILES}/${profile}

    GUIX_PROFILE="${profile_path}/${profile}"
...
** Manifests for desktop environment
- base
