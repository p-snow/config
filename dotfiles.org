...
subvolume home-%%DISTRO%%
#+end_src

#+NAME: cron/btrbk
#+begin_src conf :noweb yes :noweb-ref cronjob-user
,*/15 * * * * /usr/bin/bash -ci "which btrbk | xargs -I _ pwsudo _ --config ~/.config/btrbk/default.conf run"
#+end_src
...
- Common configuration
  #+begin_src conf :noweb tangle :tangle (expand-file-name "common/etc/keyd/common" tangle/system)
  [global]
...
- For GIBKEY G68 keyboard
  #+begin_src conf :noweb tangle :tangle (expand-file-name "common/etc/keyd/gibkey-g68.conf" tangle/system)
  [ids]
  # USB
  k:258a:0049
  # 2.4 GHz
...
topdirs = /mnt/shared/doc-%%HOSTNAME%%
