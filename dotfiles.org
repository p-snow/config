...
#+begin_src emacs-lisp
  ...
  In neither case, count down time is 25 min which is suggested in the Pomodoro-technique."
    (let* ((todo (org-get-todo-state))
           ...
           (org-timer-default-timer (or attention-span
                                        (and todo "25")
...
#+begin_src emacs-lisp
  ...
  ;;             (lambda ()
  ;;               (funcall #'my/org-clock-remove-old-clock-entries 4 5)))
  ...
  ;;   (add-hook 'org-after-todo-state-change-hook
  ;;             (lambda ()
  ;;               (funcall #'my/org-remove-old-state-change-entries 12))))
...
#+begin_src emacs-lisp
  (with-eval-after-load 'org-clock
    ...
    (add-hook 'org-clock-cancel-hook #'my/org-clock-pad-time))
