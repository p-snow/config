...
#+begin_src emacs-lisp :noweb tangle
  ...
  (defvar my/user-config-dir "~/.emacs.d/elisp/config"
    "docstring")
  (defvar my/user-batch-dir "~/.emacs.d/elisp/batch"
    "docstring")
  (defvar my/user-package-dir "~/.emacs.d/site-elisp"
    "docstring")
...
#+begin_src emacs-lisp :tangle (expand-file-name ".emacs.d/site-lisp/org-price-checker.el")
  (defvar my/org-price-checker-retrievers
    '(("www\.amazon\.co\.jp" . my/org-price-checker-retriever-amazon-jp))
    "An alist.")

  (defun my/org-price-checker-check ()
    "docstring"
    (interactive)
    (when-let* ((url (org-entry-get (point) "PRICE_URL"))
                (ret (assoc-default url my/org-price-checker-retrievers #'string-match))
                (val (funcall ret url)))
      (setq-local last-val (org-entry-get (point) "PRICE_LAST"))
      (when (or (not last-val)
        ...
        (org-entry-put (point) "PRICE_LAST" val))))
