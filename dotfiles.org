...
- festival.el
  ...
  #+begin_src emacs-lisp :noweb yes :noweb-ref additional-elisp
    (add-to-list 'load-path
                 (expand-file-name "<<festival-data-dir()>>"))
...
- data directory
  ...
  #+name: festival-data-dir
  #+begin_src shell :eval no-export
    guix package -p ~/.guix-extra-profiles/desktop/desktop --search-paths \
      | awk -F'=' '/XDG_DATA_DIRS/{print $2}' | tr -d '"' | awk '{print $1"/festival/lib"}'
  #+end_src
