...
#+NAME: template-play-media
#+begin_src emacs-lisp :tangle no :noweb-ref minibuffer-template
(play-media (p "File: " file t)
            (command/play-media file))
(play-media-no-resume (command/play-media (read-file-name "File: ") :no-resume t))
#+end_src
...
#+begin_src emacs-lisp :tangle no :noweb-ref minibuffer-template
(opus (my/command-transcode-opus
