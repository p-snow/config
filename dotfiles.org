...
(defun my/transient-infix-values (keys)
  (mapconcat 'transient-infix-value
             (delq nil (mapcar #'my/transient-suffix keys))
             " "))
...
(defclass my/shell-quoted-option (transient-files) ())

(cl-defmethod transient-infix-value ((obj my/shell-quoted-option))
  ""
...
(defclass my/shell-literal-option (transient-option) ())

(cl-defmethod transient-infix-value ((obj my/shell-literal-option))
  ""
  (and-let* ((value (oref obj value)))
    (let ((arg (oref obj argument)))
      (pcase-exhaustive (oref obj multi-value)
