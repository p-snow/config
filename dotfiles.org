     ...
     - name: Enter/Tab as Super
       remap:
         ...
         KEY_TAB:
           ...
           alone: KEY_TAB
           alone_timeout_millis: 500
     - name: SingleQuote as RightCtrl mod
       remap:
         KEY_APOSTROPHE:
           held: Ctrl_R
           alone: KEY_APOSTROPHE
           alone_timeout_millis: 500
     - name: BackSlash as Super mod
       remap:
         KEY_BACKSLASH:
           held: Super_R
           alone: KEY_BACKSLASH
...
#+begin_src emacs-lisp
  ...
  ;; M-u and H-u to `universal-argument' for usability
...
#+begin_src emacs-lisp :tangle (expand-file-name "my-org-config.el" my/user-config-dir)
  (use-package org-drill-english
    :bind (:map my/org-global-map
                ...
                ("e D" . my/org-english-drill-resume)
