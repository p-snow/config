...
- /etc/fstab file for my personal machine
  #+begin_src conf :noweb tangle :tangle ~/tmp/pc01.fstab
    ...
    UUID=98422431-b089-4dc0-b326-2693c19ace4e /mnt/ssd01/ btrfs noauto,x-systemd.automount,x-systemd.device-timeout=5,nofail,subvolid=5 0 2
    ...
    PARTUUID=71f7ecd2-01 /mnt/hdd01 ext4 defaults 0 2
