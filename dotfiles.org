...
- Automating Script
  #+begin_src conf :noweb yes :noweb-ref cronjob-pc
    0 2 * * * /bin/bash -ci "update-channels && activate-profiles && guix gc -d 2m -F 20G >> $LOG_DIR/guix-update.log 2>&1"
  #+end_src
...
#+begin_src emacs-lisp
  ...
  (customize-set-variable 'auto-save-visited-interval 20)
...
#+begin_src emacs-lisp
  ...
  (customize-set-variable 'delete-active-region 'kill)
...
#+begin_src emacs-lisp
  (use-package midnight
    ...
    :custom
    (midnight-mode t)
    ;; set timer at 2:30 a.m.
    (midnight-delay "02:30am"))
#+end_src
...
#+begin_src emacs-lisp
  (use-package git-annex
    :commands (git-annex-dired-add-files
               git-annex-dired-get-files
               git-annex-dired-drop-files
               git-annex-dired-edit-files)
    :custom-face
...
#+begin_src emacs-lisp
  (use-package org-web-track
    :after (org org-agenda my-org-global-map)
    :defer 20
