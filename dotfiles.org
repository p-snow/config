...
(use-package org-web-track
  :ensure t
  :load-path ("~/.config/emacs/var/elpa/org-web-track-20240416.1308")
...
(setopt package-build-recipes-dir
        (expand-file-name "site-lisp/recipes" user-emacs-directory)
        package-build-archive-dir
        (expand-file-name "site-lisp/packages" user-emacs-directory)
        package-build-working-dir
        (expand-file-name "site-lisp/working" user-emacs-directory))
#+end_src
