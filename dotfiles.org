...
(keymap-global-set "H-d" #'backward-delete-char)
(keymap-global-set "H-D" #'backward-kill-word)
...
(use-package vterm
  ...
  (bind-keys :map vterm-mode-map
             ("H-d" . vterm-send-backspace)
             ("H-D" . vterm-send-meta-backspace)
             ("C-y" . vterm-yank)
             ("M-y" . vterm-yank-pop)
             ("M-l" . nil)
...
(use-package vertico
  :bind (:map vertico-map
              ...
              ("H-d" . vertico-directory-delete-char)
              ("H-D" . vertico-directory-delete-word)
