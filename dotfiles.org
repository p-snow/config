...
- /etc/fstab file for my personal machine
  #+begin_src conf :noweb tangle :tangle pc01.fstab
    ...
    sshfs#<<account()>>@sv04.<<network()>>:/home/<<account()>> /mnt/sv04 fuse defaults,x-systemd.automount,allow_other,nonempty,IdentityFile=<<home-dir()>>/.ssh/id_rsa,ServerAliveInterval=60,_netdev 0 2
  #+end_src
