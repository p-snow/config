...
- xkeysnail.service
  #+begin_src conf :tangle (expand-tangle-target ".config/systemd/user/xkeysnail.service")
    ...
    [Service]
    KillMode=process
    ExecStart=%h/.local/bin/pwsudo /usr/local/bin/xkeysnail --watch --quiet %h/.config/xkeysnail/config.py
  ...
  #+end_src
** how to activate xkeysnail when usb keyboard replug
1. Install xkeysnail
   Install xkeysnail (v0.4.0) on python3 on system via pip3
...
- /etc/fstab file for my personal machine
  #+begin_src conf :noweb tangle :tangle pc01.fstab
    UUID=98422431-b089-4dc0-b326-2693c19ace4e /mnt/ssd01/ btrfs noauto,x-systemd.automount,defaults 0 2
    UUID=98422431-b089-4dc0-b326-2693c19ace4e <<home-dir()>>/doc btrfs noauto,x-systemd.automount,relatime,space_cache,compress=zstd,subvolid=710 0 0
    UUID=98422431-b089-4dc0-b326-2693c19ace4e <<home-dir()>>/work btrfs noauto,x-systemd.automount,relatime,space_cache,compress=zstd,subvolid=717 0 0

    UUID=92a594bc-2800-48fd-a2f9-6e735ec5cfca /mnt/hdd01 btrfs noauto,x-systemd.automount,defaults,relatime,space_cache,subvolid=5,subvol=/ 0 2

    sshfs#<<account()>>@ns01:/home/<<account()>>/share /mnt/ns01 fuse defaults,x-systemd.automount,allow_other,nonempty,IdentityFile=<<home-dir()>>/.ssh/id_rsa,ServerAliveInterval=60,_netdev 0 2
    sshfs#<<account()>>@sv04.<<my-network()>>:/home/<<account()>> /mnt/sv04 fuse defaults,x-systemd.automount,allow_other,nonempty,IdentityFile=<<home-dir()>>/.ssh/id_rsa,ServerAliveInterval=60,_netdev 0 2
  #+end_src
