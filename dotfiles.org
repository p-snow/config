...
**** early-init.el
:PROPERTIES:
:header-args+: :tangle (expand-file-name "early-init.el" tangle/user-emacs-directory) :tangle-mode (identity #o644)
:END:
...
#+begin_src shell :noweb tangle :tangle (expand-file-name "emacs-everywhere" tangle/local-bin-dir)
