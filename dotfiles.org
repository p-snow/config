...
#+begin_src emacs-lisp :tangle (expand-file-name "my-org-config.el" my/user-config-dir)
  (use-package org-web-track
    :bind (("C-o W g" . org-web-track-update)
           ("C-o W W" . my/org-web-track-list)
           :map org-agenda-mode-map
           ("W" . org-agenda-web-track-columns))
    :preface
    (defun org-web-track-probe--amazon-jp (url)
        ...
        (when (require 'org-ql nil t)
          (org-ql-search
            ...
            :super-groups '((:tag "ac_buy")
                            (:tag "food"))))))
    :custom
    (org-web-track-probe-functions
     '(("www\.amazon\.co\.jp" . org-web-track-probe--amazon-jp)))
...
#+begin_src emacs-lisp :tangle (expand-file-name "org-web-track.el" my/user-package-dir)
  ...
  (defcustom org-web-track-probe-functions nil
    ...
    (let ((url (org-entry-get (point) "TRACK_URL"))
      ...
      (unless (or (and (not url)
        ...
        (and (not
              (setq val
                    (with-temp-buffer
                      (call-process-shell-command (format "curl --silent -A 'Mozilla/5.0' \"%s\""
                                                          url)
                                                  nil '(t . nil))
                      (funcall (assoc-default url org-web-track-probe-functions #'string-match)
                               url)
  ...
  (let (mail-msg)
    (mapc (lambda (price-entry)
            (let* ((heading (org-element-property :raw-value price-entry))
                   ...
                   (value (funcall (assoc-default track-url org-web-track-probe-functions #'string-match)
                                   track-url)))
...
#+begin_src emacs-lisp :tangle (expand-file-name "my-org-config.el" my/user-config-dir)
  (use-package org-drill-english
    ...
    :bind (("C-o e e" . my/org-english-capture)
           ...
           ("C-c l p" . my/org-english-insert-japanese-pronunciation)))
#+end_src
...
#+begin_src emacs-lisp  :tangle (expand-file-name "org-drill-english.el" my/user-package-dir)
  ...
  (with-eval-after-load 'org-capture
    (add-to-list 'org-capture-templates
                 '("!0" "drill entry for english word"
                   ...
                   "* %i :drill:fd_en:
  [%(my/org-english-insert-japanese-translation) %(my/org-english-insert-japanese-pronunciation org-english-word t)]
  ...
  (defun my/org-english-insert-japanese-pronunciation (word &optional sync)
