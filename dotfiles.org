...
#+begin_src emacs-lisp
  (defvar skk-data-dir (expand-file-name "~/share/skk"))
  ...
  (use-package ddskk
    ...
    (skk-init-file "~/.emacs.d/lisp/ddskk/init.el")
...
#+begin_src emacs-lisp :tangle (expand-tangle-target ".emacs.d/lisp/ddskk/init.el")
  ;; -*- mode:emacs-lisp; -*-
