  ...
  (use-package Info
    ...
    (Info-additional-directory-list
     (append `(,(expand-file-name "~/.local/share/info")
               ,(expand-file-name "~/.guix-extra-profiles/base/base/share/info")
               ,(expand-file-name "~/.guix-extra-profiles/desktop/desktop/share/info"))))
    :config
    (require 'info-look)
...
- how to change default storage pool
  1. delete pre-existing default pool whose name is 'default'
     : $ virsh pool-destroy default
  2. apply customized pool
     : % virsh pool-create ~/.config/libvirt/pool.xml

#+begin_src xml :noweb tangle :tangle (expand-tangle-target ".config/libvirt/pool.xml")
  <pool type='dir'>
    <name>default</name>
    <uuid>33f96916-e0d8-40fd-9323-859ed69e9e35</uuid>
    <capacity unit='bytes'>123316453376</capacity>
    <allocation unit='bytes'>82347986944</allocation>
    <available unit='bytes'>40968466432</available>
    <source>
    </source>
    <target>
...
#+begin_src shell :tangle (expand-tangle-target ".local/bin/av1encode") :tangle-mode (identity #o555)
  ...
  vp9_opts_pass1='-c:v libaom-av1 -cpu-used 4 -row-mt 1 -threads 4 -b:v 0 -crf 23 -pass 1 -an -f null'
  vp9_opts_pass2='-c:v libaom-av1 -cpu-used 4 -row-mt 1 -threads 4 -b:v 0 -crf 23 -pass 2 -map_metadata 0'
  opus_opts='-c:a libopus -b:a 128k -ac 2'
