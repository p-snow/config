...
(defun my/decrease-number-at-point-by-1 ()
  "Decrease the number at point by 1."
  (interactive)
  (funcall #'my/increase-number-at-point -1))
...
(defvar-keymap my/increase-number-repeat-map
  ...
  :repeat (:enter (my/increase-number-at-point
                   my/decrease-number-at-point-by-1))
  "<up>" #'my/increase-number-at-point
  "<down>" #'my/decrease-number-at-point-by-1)
#+end_src
